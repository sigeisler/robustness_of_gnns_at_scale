...
parser = argparse.ArgumentParser(
    description='Locally run one of the experiments',
    formatter_class=argparse.ArgumentDefaultsHelpFormatter
)
parser.add_argument('--config-files', nargs='+', type=str,
                    default=[os.path.join('seml', 'attack_evasion_transfer', 'cora.yaml')],
...
def main(args: argparse.Namespace):
    configs, run = build_configs_and_run(args.config_files, None, args.kwargs)
