...
def config():
    ...
    seeds = [0, 1, 5]
    db_collection = "kdd21_local_attack_citeseer"
    artifact_dir = 'cache'
...
@ex.automain
def run(data_dir: str, dataset: str, db_collection: str, binary_attr: bool, make_undirected: bool,
    ...
    logging.info({
        'dataset': dataset, 'db_collection': db_collection, 'binary_attr': binary_attr, 'model_labels': model_labels,
    ...
    df_attack_experiments = seml.get_results(db_collection,
                                             to_data_frame=True,
