...
class EXPAND_CONTRACT():
    ...
    def _contract(self, adj_dict, cohort, adj_symmetric_index, adj_symmetric_weights, n_perturbations):
        ...
        while len(cohort) > n_perturbations: #//self.k:
            ...
            for i, edge in enumerate(cohort):
                adj_dict, adj_symmetric_index, adj_symmetric_weights = self._flip_edges(adj_dict, edge, adj_symmetric_index, adj_symmetric_weights)
    ...
    def attack(self, 
        ...
        adj_dict, adj_symmetric_index, adj_symmetric_weights = self._flip_edges(adj_dict, cohort, adj_symmetric_index, adj_symmetric_weights)
        ...
        if n_expand > 0:
            ...
            for _ in range(self.m - 1): #//range(n_perturbations - 1): 
                adj_dict, adj_symmetric_index, adj_symmetric_weights = self._contract(adj_dict,cohort, adj_symmetric_index, adj_symmetric_weights, n_perturbations)
                bar.update()
                new_edges = self._add_edges_to_list([], n_expand)
                adj_dict, adj_symmetric_index, adj_symmetric_weights = self._flip_edges(adj_dict, new_edges, adj_symmetric_index, adj_symmetric_weights)
