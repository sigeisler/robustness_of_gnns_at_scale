...
class DICE(object):
    ...
    def __init__(self,
        ...
        self.n = adj.size()[0]
        self.adj = adj
        #TODO: Adding dictionary, checking if matrix is symmetrical
    ...
    def __deletingEdges(self, delete_budget, adj, labels):
    ...
    def __performAttack(self, to_be_deleted_set, to_be_added_set, adj):
    ...
    def attack(self,
        ...
        to_be_deleted_set = self.__deletingEdges( delete_budget, adj, labels)
        to_be_added_set = self.__addingEdges(labels, adj, add_budget)
        # Perform the attack and update the self.adj_adversary Matrix
        self.__performAttack(to_be_deleted_set, to_be_added_set, adj)
        indices = []
        values = []
        ...
        self.adj_adversary = torch.sparse.FloatTensor(i.t(), v, torch.Size([self.n, self.n]))
