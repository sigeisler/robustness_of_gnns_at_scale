...
from rgnn_at_scale.utils import calc_ppr_update, calc_ppr_update_dense, calc_ppr_update_topk_dense, calc_ppr_exact_row, calc_A_row
...
class TestPPRUpdate():
    ...
    def test_simple_example_sparse(self):
        ...
        p_dense = torch.tensor([[0.5, 0.0, 0, 0.3]],
                               dtype=torch.float32,
                               requires_grad=True)
